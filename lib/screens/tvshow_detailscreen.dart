...
class _TVDescriptionState extends State<TVDescription> {
  int seasonindex = 0;
  Color seasoncolor = Colors.blueAccent;
  @override
            ...
            builder: (BuildContext context, AsyncSnapshot snapshot) {
              if (snapshot.hasData) {
                return ListView(scrollDirection: Axis.vertical, children: [
                  ...
                  Row(
                    ...
                    children: [
                        ...
                        children: [
                          ...
                          Text(
                            snapshot.data.voteAverage
                                ...
                                .substring(0, 3),
                            style:
                                TextStyle(fontSize: 19, color: uppermodecolor),
                          ),
                        ],
                      ),
                      const SizedBox(
                      ...
                      Text(
                        ...
                        style: TextStyle(fontSize: 17, color: uppermodecolor),
                      )
                    ],
                  ),
                  Container(
                  ...
                  SizedBox(
                    height: snapshot.data.seasons[seasonindex].episodeCount *
                            (70).toDouble() +
                        20.00,
                    child: ListView.builder(
